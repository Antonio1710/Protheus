...
±±ºPrograma  ³ADEST035P ºAutor  ³WILLIAM COSTA       º Data ³  14/11/2018 º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ VALIDACAO DO CAMPO BE_LOCALIZ PARA NAO DEIXAR TER ESPACO   º±±
...
USER FUNCTION ADEST035P()
	...
	IF INCLUI == .T.
		...
		IF AT(' ',ALLTRIM(M->BE_LOCALIZ)) > 0
			...
			MsgStop("OLÁ " + Alltrim(cUserName) + ", Campo de Localização não pode ter espaço em branco.", "ADEST035P")
			lRet := .F.
