...
±±ºPrograma  ³MT440GR  º Autor ³ Fernando Sigoli    º Data ³  04/07/17   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDescricao ³ Ponto de Entrada na liberação de pedidos manual            º±±
±±º          ³ Chamado: 036107                                            º±±
...
Local cParam	  := PARAMIXB[1]
	...
	If cParam == 1 //confirmou a liberação do pedido
