...
±±ºPrograma  ADEEC003P º Autor ³ Fernando Sigoli     º Data ³  08/10/18   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDescricao ³ Cadastro de Grupo de inspeção              				  º±±
±±º          ³ Relacionado na tabela de clientes SA1 e SC5                º±±
...
User Function ADEEC003P()  //U_ADEEC003P()
    Local aArea   := GetArea()
    Local oBrowse
...
Static Function MenuDef()
    ...
    //Adicionando opções
    ADD OPTION aRot TITLE 'Visualizar' ACTION 'VIEWDEF.ADEEC003P' OPERATION MODEL_OPERATION_VIEW   ACCESS 0 //OPERATION 1
    ADD OPTION aRot TITLE 'Legenda'    ACTION 'u_EC003Leg'       OPERATION 6                      ACCESS 0 //OPERATION X
    ADD OPTION aRot TITLE 'Incluir'    ACTION 'VIEWDEF.ADEEC003P' OPERATION MODEL_OPERATION_INSERT ACCESS 0 //OPERATION 3
    ADD OPTION aRot TITLE 'Alterar'    ACTION 'VIEWDEF.ADEEC003P' OPERATION MODEL_OPERATION_UPDATE ACCESS 0 //OPERATION 4
    ADD OPTION aRot TITLE 'Excluir'    ACTION 'VIEWDEF.ADEEC003P' OPERATION MODEL_OPERATION_DELETE ACCESS 0 //OPERATION 5
...
Static Function ViewDef()
    ...
    Local oModel := FWLoadModel("ADEEC003P")
