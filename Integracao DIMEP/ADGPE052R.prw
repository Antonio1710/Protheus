...
Static Function SqlGeral()
    ...
    BeginSQL Alias "TRB"
		    ...
		    SELECT NM_PESSOA,
			       ...
			       ISNULL((SELECT TOP(1) NU_DATA_REQUISICAO FROM [DIMEP].[DMPACESSOII].[DBO].[LOG_ACESSO] WHERE LOG_ACESSO.NU_MATRICULA = PESSOA.NU_MATRICULA ORDER BY LOG_ACESSO.NU_DATA_REQUISICAO DESC),0) AS DATA_ULTIMA_PASSAGEM_DIMEP,
			       NM_ESTRUTURA,
			       DS_RAZAO_SOCIAL,
			       NU_CNPJ
