//#include "rwmake2.ch"       ENTROU EM CONFLITO COM PROTHEUS.CH
#INCLUDE "PROTHEUS.CH"  
#INCLUDE "WINAPI.CH"
#INCLUDE "FIVEWIN.CH"
#include "topconn.ch"
...
±±³Fun‡…o    ³ PriPeso  ³ Autor ³Daniel Pitthan Silveira³ Data ³ 11/07/05 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descri‡…o ³ Primeira Pesagem (Peso da Tara do Veiculo )                ³±±
±±³          ³                                                            ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³Sintaxe   ³ PriPeso, Sub-Funcao de MENUBALA                            ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
...
//_cQuery += "ZV1_CODFOR = '"+_nCodFor+"' and ZV1_LOJFOR = '"+_nLojFor+"' and "
