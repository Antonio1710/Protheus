...
±±ºPrograma  ³AD0135    º Autor ³ Daniel             º Data ³  11/07/05   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDescricao ³ Codigo gerado pelo AP6 IDE.                                º±±
±±º          ³ Manutencao  Tabela ZV1 do Frango Vivo                      º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºUso       ³Especifico Adoro                                            º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³Funcoes internas:                                           º±±
±±º          ³AD0135(), FUNCAO PRINCIPAL, MONTA MBROW                     º±±
±±º          ³LGDFV1(), MONTA LEGENDA									  º±± 
±±º          ³ALTFV1(), VALIDA ALTERACAO DO ZV1                           º±±
±±º          ³DELFV1(), VALIDA A EXCLUSAO                                 º±±
±±º          ³MNTFRT(), MANUTENCAO DO FRETE 							  º±±
