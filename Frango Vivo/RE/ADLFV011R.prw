...
/*/{Protheus.doc} User Function ADLFV011R
	...
	@history ticket 72339 - Fernando Macieira - 23/05/2022 - chumbado empresa e filial devido error log na passagem do parโmetro - enqto aguardamos solu็ใo TOTVS
/*/
...
User Function ADLFV011R()
	...
	// @history ticket 72339 - Fernando Macieira - 23/05/2022 - chumbado empresa e filial devido error log na passagem do parโmetro
	// @history ticket 72339 - Fernando Macieira - 03/05/2022 - workflow - ACOMPANHAMENTO DAS NOTAS FISCAIS DE FRANGO VIVO
	//Default cEmpJob := "01"
	//Default cFilJob := "02"
	Local cEmpJob := "01"
