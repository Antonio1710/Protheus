...
Static Function EmailFVL()
	...
	logZBN("ACOMPANHAMENTO DAS NOTAS FISCAIS DE FRANGO VIVO - " + DtoC(msDate()) ) // @history ticket 72339 - Fernando Macieira - 20/05/2022 - workflow - ACOMPANHAMENTO DAS NOTAS FISCAIS DE FRANGO VIVO - inclusใo de logs pois manualmente o email dispara e no schedule nใo
	ProcRel()
