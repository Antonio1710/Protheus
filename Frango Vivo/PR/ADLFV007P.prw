...
ฑฑบPrograma  |ADLFV007P บ Autor ณ Fernando Sigoli    บ Data ณ  10/04/17   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDescricao ณ Tipos de Ocorrencias de Frete [ABATIDO/VIVO]               บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ Adoro                                                      บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบAltera็ใo ณ Everson-07/03/2019. Chamado 044314. Valida็lใo na exclusใo บฑฑ
ฑฑบ          ณ /altear็ใo do registro. Alterada rotina para MVC.          บฑฑ
...
User Function ADLFV007P()
	...
	oBrowse := FWMBrowse():New()
		...
		oBrowse:SetDescription("Cadastro de Tipos de Ocorr๊ncias de Frete")
	oBrowse:Activate()
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  |ADLFVP01  บ Autor ณ Everson            บ Data ณ 07/03/2019  บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDescricao ณ Rotina.                                                    บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
Static Function ModelDef()
	...
	oModel:SetDescription("Manuten็ใo de Tipos de Ocorr๊ncia")
...
ฑฑบPrograma  |ADLFVP01  บ Autor ณ Everson            บ Data ณ 07/03/2019  บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDescricao ณ P๓s valida็ใo.                                             บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ Chamado 044314.                                            บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
...
Static Function ADLFVP01(oModel)
    ...
    //Valida็ใo de exclusใo.
    If nOperation == 5
    
    	//Verifica se o tipo de ocorr๊ncia jแ foi utilizado nos lan็amentos de frete.
    	DbSelectArea("ZFA")
    	ZFA->(DbSetOrder(3))
    	ZFA->(DbGoTop())
    	If ZFA->(DbSeek( FwFilial("ZFA") + cCodigo ))
	    	lRet := .F.   
	        Help( ,, "A็ใo nใo Permitida",, "Tipo de ocorr๊ncia de frete jแ utilizada nos lan็amentos de frete.", 1, 0, Nil, Nil, Nil, Nil, Nil, {""})
	        
        EndIf
        
        //Valida a exclusใo de lan็amento automแtico.
        If cTpLanc == "S" .And. ! FwIsAdmin()
        	lRet := .F.   
        	Help( ,, "A็ใo nใo Permitida",, "Lan็amento automแtico nใo pode ser alterado.", 1, 0, Nil, Nil, Nil, Nil, Nil, {""}) 
    ...
    ElseIf nOPeration == 4 
    	...
    	If cTpLanc == "S" .And. ! FwIsAdmin() //Valida a altera็ใo de lan็amento automแtico.
	    	lRet := .F.   
		    Help( ,, "A็ใo nใo Permitida",, "Lan็amento automแtico nใo pode ser alterado.", 1, 0, Nil, Nil, Nil, Nil, Nil, {""})
	...
	If lRet .And. ! Empty(cOperacao)
		logZBE( cOperacao + " de tipo de ocorr๊ncia de frete","Ocorr๊ncia " + cValToChar(cCodigo) )
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  |ADLFVP02  บ Autor ณ Everson            บ Data ณ 07/03/2019  บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDescricao ณ Importa CSV com tipos de ocorr๊ncia.                       บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ Chamado 044314.                                            บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
...
User Function ADLFVP02()
	...
	Processa({||  ADLFVP03() },"Importando tipos de ocorr๊ncias de frete...")
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  |ADLFVP03  บ Autor ณ Everson            บ Data ณ 07/03/2019  บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDescricao ณProcessa importa็ใo de CSV de tipos de ocorr๊ncias de frete.บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ Chamado 044314.                                            บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
...
Static Function ADLFVP03()
	...
	//Valida arquivo.  
	If Empty(cArq)
		MsgStop( "Nใo foi possํvel obter o arquivo.","ADLFVP03(ADLFV007P)")
		Return Nil
	...
	If nHdl == -1
		MsgStop("Nใo foi possํvel abrir o arquivo " + Chr(13) + Chr(13) + cArq,"ADLFVP03(ADLFV007P)")
		Return Nil
	...
	While ! FT_FEof()
		...
		If ! Empty(cBuffer)
			...
			If Len(aDados) <> 5
				MsgStop("O arquivo CSV deve ser composto de Descri็ใo; Valor Padrใo; D้bito ou Cr้dito;Percentual; Abastecimento .","ADLFVP03(ADLFV007P)")
				Return Nil
			...
			//
			If Empty(cDesc)
				MsgStop("Linha " + cValToChar(i) + ": nใo possui descri็ใo ","ADLFVP03(ADLFV007P)")
				Loop
				
			ElseIf !( cDB $("D|C") )
				MsgStop("Linha " + cValToChar(i) + ": necessแrio informar se a ocorr๊ncia ้ cr้dito (C) o d้bito (D). ","ADLFVP03(ADLFV007P)")
				FT_FSkip()
				Loop
				
			ElseIf nValor > 0 .And. nPerc
				MsgStop("Linha " + cValToChar(i) + ": somente informe o valor ou o percentual maior que 0, nใo os dois. ","ADLFVP03(ADLFV007P)")
				FT_FSkip()
				Loop
			...
			If RecLock("ZF7",.T.)
				...
				logZBE("Inclusใo de tipo de ocorr๊ncia de frete","Ocorr๊ncia " + cValToChar(cCodigo) )
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  |logZBE    บ Autor ณ Everson            บ Data ณ 07/03/2019  บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDescricao ณ P๓s valida็ใo.                                             บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
