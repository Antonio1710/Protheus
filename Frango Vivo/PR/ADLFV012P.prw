...
±±ºPrograma  ³ADLFV012P ºAutor  ³Fernando Macieira   º Data ³  05/30/18   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ Funcao utilizada no X3_VLDUSER do campo ZV5_NUMNFS         º±±
±±º          ³ Chamado 041138                                             º±±
...
If lRet
	...
	_cQuery += "FROM "+retsqlname("ZV1") +" WHERE RTRIM(LTRIM(ZV1_NUMNFS)) = '"+RemvZero(ALLTRIM(M->ZV5_NUMNFS))+"' and "
