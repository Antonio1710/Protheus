...
±±ºPrograma  ³ADINF006P º Autor ³ WILLIAM COSTA      º Data ³  13/02/17   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDescricao ³ BROWSER PARA OS GESTORES VEREM OS CHAMADOS DA TI           º±±
±±º          ³                                                            º±±
...
User Function ADINF007P()
	...
	Private aRotina   := {{"Acompanhamento","U_Acomp07",0,1},;
	                      {"Visualizar"    ,"U_VISU07" ,0,2},;
	                      {"Apontamentos"  ,"U_Apont07"    ,0,3},;
					      {"LEGENDA"       ,"U_Leg07"  ,0,4}}
	Private cArqTRB   := ""
	Private cInd1     := ""
	Private cInd2     := ""
...
USER FUNCTION Acomp07()   
	...
	U_ADINF009P('ADINF007P' + '.PRW',SUBSTRING(ALLTRIM(PROCNAME()),3,LEN(ALLTRIM(PROCNAME()))),'BROWSER PARA OS GESTORES VEREM OS CHAMADOS DA TI')
...
Static Function SqlGeral()
	...
	BeginSQL Alias "TMP0"
			...
			SELECT PAA_CHAMAD,
			 ...
			 WHERE AA1_CODUSR              = '000071'//%EXP:__cUserID%
