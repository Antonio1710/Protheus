		...
		For nCountNF := 1 To Len(aCupRefLoj)
			...
			If MsSeek(xFilial("SF2")+cNota+cSerie+cClieFor+cLoja)
				...
				Else
					...
					If !Empty( SF2->F2_PLACA ) //.And. cEmpAnt == "01"  Desabilitada condicao para executar bloco para Ceres igual Adoro em 21/02/2017 por Adriana chamado 033526// &&Mauricio - 29/03/10 Tratamento para NFE Ceres.         
	...
	*/				
					...
					While !Eof() .And. xFilial("SD2") == (cAliasSD2)->D2_FILIAL .And.;
						...
						If lContinua
							...
							If cEmpAnt == "01"   &&Mauricio 29/03/10 - Tratamento para NF Ceres.
	...
	//				cDescProd := SB1->B1_DESC 
				...
				If SF1->F1_EST <> 'EX'   // <> Nota de Importacao 	
					...
					If cEmpAnt == "01"     &&Mauricio 29/03/10 - Tratamento para empresa Ceres.
